...
You have now learned how stop tokens provide cooperative cancellation for coroutines. The next section covers concurrent composition with cpp:when_all[] and `when_any`.
