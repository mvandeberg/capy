...
When a coroutine completes or awaits another coroutine, control must transfer somewhere. The naive approach—calling `handle.resume()`—has a problem: each nested coroutine adds a frame to the call stack. With deep nesting, you risk stack overflow.
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=task_chain,indent=0]
----
...
`await_suspend`'s return type can be one of three types, each meaning something different:
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=symmetric_await_suspend,indent=0]
----
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=generator_final_suspend,indent=0]
----

== Coroutine Allocation

Every coroutine needs memory for its *coroutine frame*—the structure, typically heap-allocated, holding local variables, parameters, and suspension state.
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=halo,indent=0]
----
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=custom_operator_new,indent=0]
----
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=unhandled_terminate,indent=0]
----
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=unhandled_store,indent=0]
----
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=unhandled_rethrow,indent=0]
----
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=unhandled_swallow,indent=0]
----
...
[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=store_and_rethrow,indent=0]
----
...
[source,cpp]
----
include::example$programs/Bd_advanced_exception.cpp[tag=full]
----
...
Here is a production-quality generic generator:

[source,cpp]
----
include::example$snippets/Bd_advanced.cpp[tag=production_generator]
----
