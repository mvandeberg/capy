...
Each component should have a single purpose. Ideally, all functionality within a component is primitive. If you can write a function in terms of a type rather than as a member of that type, write a free function (or today, a template function constrained by a concept). This keeps levels flat and CCD low.
...
== Write Against the Narrowest Interface
