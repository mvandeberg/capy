...
This section introduces the concepts that form Capy's vocabulary for data flow. It explains the distinction between partial and complete I/O, and how the composed algorithms build on the stream concepts. The section also covers physical isolation, which lets you write I/O logic that is composable, testable, and independent of any particular transport. Once you understand these concepts, every I/O operation in the library feels familiar.
