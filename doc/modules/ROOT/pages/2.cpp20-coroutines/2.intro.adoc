...
* xref:2.cpp20-coroutines/2a.foundations.adoc[Coroutine Foundations] -- How normal function
  calls work, and what a coroutine's suspend/resume model changes.
* xref:2.cpp20-coroutines/2b.syntax.adoc[{cpp}20 Syntax] -- The `co_await`,
  `co_yield`, and `co_return` keywords, and how the compiler builds awaitables.
* xref:2.cpp20-coroutines/2c.machinery.adoc[Coroutine Machinery] -- Promise types
  and coroutine handles, the machinery behind suspension and resumption.
* xref:2.cpp20-coroutines/2d.advanced.adoc[Advanced Topics] -- Symmetric transfer,
