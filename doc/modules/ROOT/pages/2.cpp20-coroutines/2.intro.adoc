...
This section takes you from zero to a working understanding of {cpp}20 coroutines. No prior experience with coroutines or async programming is needed. You start with the problem that coroutines solve, then move through the language syntax and compiler machinery. Finally you reach the performance characteristics that make coroutines practical for real systems. By the end, you understand not only _how_ to write coroutines but _why_ they work the way they do. That knowledge makes everything in the rest of this documentation click into place.
