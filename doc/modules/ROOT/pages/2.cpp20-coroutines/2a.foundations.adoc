...
* A {cpp} compiler with {cpp}20 support (GCC 12+, Clang 17+, or MSVC 14.34+)
...
You have now learned what coroutines are and why they exist. The next section covers the {cpp}20 syntax for creating coroutines.
