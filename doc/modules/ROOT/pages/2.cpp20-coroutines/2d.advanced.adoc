...
These fundamentals prepare you for understanding Capy's cpp:task[task<T>] type and the IoAwaitable protocol, which build on standard coroutine machinery with executor affinity and stop token propagation.
