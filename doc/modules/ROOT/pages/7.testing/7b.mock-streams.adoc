...
cpp:test::read_stream[] implements the `ReadStream` concept. Test code stages bytes
...
cpp:test::write_stream[] implements the `WriteStream` concept. The system under
