...
This section introduces the dangers of shared data access and the synchronization primitives that protect against them. It covers race conditions, mutexes, lock guards, and deadlocks.
...
[source,cpp]
----
include::example$programs/3b_synchronization_race.cpp[tag=full]
----

Two threads, each incrementing 100,000 times. You would expect 200,000. But run this repeatedly and you see different results—180,000, 195,327, maybe occasionally 200,000. Something is wrong.
...
[source,cpp]
----
include::example$programs/3b_synchronization_mutex.cpp[tag=full]
----
...
[source,cpp]
----
include::example$snippets/3b_synchronization.cpp[tag=lock_guard]
----
...
Since {cpp}17, `std::scoped_lock` is preferred. It works like `lock_guard` but can lock multiple mutexes simultaneously, avoiding a class of deadlock:

[source,cpp]
----
include::example$snippets/3b_synchronization.cpp[tag=scoped_lock,indent=0]
----
...
[source,cpp]
----
include::example$snippets/3b_synchronization.cpp[tag=unique_lock,indent=0]
----
...
[source,cpp]
----
include::example$snippets/3b_synchronization.cpp[tag=deadlock]
----
...
[source,cpp]
----
include::example$snippets/3b_synchronization.cpp[tag=scoped_lock_multi]
----
...
You have now learned about race conditions, mutexes, lock guards, and deadlocks. The next section covers advanced synchronization primitives: atomics, condition variables, and shared locks.
