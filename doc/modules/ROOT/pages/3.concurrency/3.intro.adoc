...
This section builds your understanding of concurrency from first principles. No prior experience with threads or parallel programming is needed. It covers what makes concurrent code hard to reason about, how the standard synchronization tools work, and the architectural patterns that tame that complexity. When you finish, you have the vocabulary and mental models to understand how Capy's coroutine-based concurrency works under the hood. That understanding includes why it eliminates entire categories of the bugs described here.
