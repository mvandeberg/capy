...
Capy is not installed as a system package, so point the compiler at your
own checkout's include directory and built library. Replace both paths
below with where you built Capy:

[source,bash,role=pseudocode]
----
