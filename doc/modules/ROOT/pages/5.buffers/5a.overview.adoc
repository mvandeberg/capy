...
Capy provides `const_buffer` and cpp:mutable_buffer[] as semantically neutral buffer types. They have known layout compatible with OS structures (`iovec`, `WSABUF`) without imposing `std::byte` semantics.
